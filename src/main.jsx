...
function App() {
  ...
  function selectCurrentFilter() {
    if (activeFilter === 'ksc100') {
      setSelectedSymbols(indexMembership.ksc100.filter((s) => comparisonSymbols.includes(s)));
    } else if (activeFilter === 'ksc30') {
      setSelectedSymbols(indexMembership.ksc30.filter((s) => comparisonSymbols.includes(s)));
    } else {
